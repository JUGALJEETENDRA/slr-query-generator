...
from litsync_app.screening.local.cache import JsonDiskCache, cache_key
from litsync_app.screening.local.contracts import (
    SCHEMA_VERSION,
    PaperAssessment,
    PaperEvidence,
    ReviewProtocol,
...
from litsync_app.screening.external.engine import InjectedStructuredEngine
from litsync_app.screening.local.evidence import evidence_lookup
from litsync_app.screening.local.hardware import RuntimeProfile, TIERS, resolve_runtime_profile
from litsync_app.screening.external.prompts import (
    assessment_prompt,
    critic_prompt,
    evidence_prompt,
