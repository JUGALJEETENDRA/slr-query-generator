...
def _result_semantic_fields(result, prefix=""):
    return {
        ...
        f"{prefix}corpus_dynamic_method_terms": result.get("rq_corpus_dynamic_method_terms", ""),
        f"{prefix}corpus_dynamic_task_terms": result.get("rq_corpus_dynamic_task_terms", ""),
        f"{prefix}corpus_dynamic_context_terms": result.get("rq_corpus_dynamic_context_terms", ""),
        f"{prefix}corpus_dynamic_profile_terms": result.get("rq_corpus_dynamic_profile_terms", ""),
        f"{prefix}rq_dynamic_extraction_used": result.get("rq_rq_dynamic_extraction_used", ""),
        f"{prefix}rq_dynamic_extraction_reason": result.get("rq_rq_dynamic_extraction_reason", ""),
        ...
        f"{prefix}domain_llm_judge_used": result.get("domain_llm_judge_used", False),
        f"{prefix}domain_llm_judge_error": result.get("domain_llm_judge_error", ""),
        f"{prefix}domain_llm_decision_hint": result.get("domain_llm_decision_hint", ""),
        f"{prefix}domain_llm_confidence": result.get("domain_llm_confidence", 0.0),
        f"{prefix}domain_llm_method_match": result.get("domain_llm_method_match", False),
        f"{prefix}domain_llm_context_match": result.get("domain_llm_context_match", False),
        f"{prefix}domain_llm_task_match": result.get("domain_llm_task_match", False),
        f"{prefix}domain_llm_missing_dimensions": result.get("domain_llm_missing_dimensions", ""),
        f"{prefix}domain_llm_reason": result.get("domain_llm_reason", ""),
        f"{prefix}domain_llm_cache_hit": result.get("domain_llm_cache_hit", False),
        f"{prefix}domain_llm_cache_source": result.get("domain_llm_cache_source", ""),
        f"{prefix}domain_llm_cache_key": result.get("domain_llm_cache_key", ""),
        f"{prefix}domain_llm_timing_seconds": result.get("domain_llm_timing_seconds", 0.0),
        f"{prefix}domain_llm_route": result.get("domain_llm_route", ""),
        f"{prefix}domain_llm_trigger_reason": result.get("domain_llm_trigger_reason", ""),
        f"{prefix}local_ai_generalization_used": result.get("local_ai_generalization_used", False),
